# zsh async right-prompt: Arch updates (official repo vs AUR)
...
# - Install: put in a file and `source` it from ~/.zshrc
...
_arch_upd_precmd() {
  ...
  RPROMPT="$(_arch_upd_rprompt_build)"
}
